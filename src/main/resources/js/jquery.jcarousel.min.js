...
!function (a) {
    ...
    a.jCarousel.plugin("jcarousel", {
        ...
        closest: function () {
            var b, c = this, e = this.list().position()[this.lt], f = a(), g = !1,
        ...
        scroll: function (b, c, d) {
            ...
            if (e.relative) {
                ...
                } else if (this.inTail) this._scroll(Math.max(this.index(this._first) - o + 1, 0), c, d); else if (g = this.index(this._first), f = this.index(this._target), i = this.underflow ? f : g, h = i - o, i <= 0 && (this.underflow && "circular" === p || "both" === p || "first" === p)) this._scroll(n, c, d); else if (this.circular && h < 0) {
        ...
        moveBy: function (a, b) {
            var c = this.list().position(), e = 1, f = 0;
        ...
        _prepare: function (b) {
            var c, e, f, g, h = this.index(b), i = h, j = this.dimension(b), k = this.clipping(),
                l = this.vertical ? "bottom" : this.rtl ? "left" : "right", m = this.options("center"),
                n = {target: b, first: b, last: b, visible: b, fullyvisible: j <= k ? b : a()};
            if (m && (j /= 2, k /= 2), j < k) for (; ;) {
            ...
            if (!this.circular && !m && j < k) for (i = h; ;) {
                if (--i < 0) break;
    ...
    a.each(e, function (a, e) {
        ...
        _options: {target: "+=1", interval: 3e3, autostart: !0}, _timer: null, _started: !1, _init: function () {
            this.onDestroy = a.proxy(function () {
                this._destroy(), this.carousel().one("jcarousel:createend", a.proxy(this._create, this))
